					...
					<form class="search_form" action="<?php echo base_url()."search"; ?>" method="post">
						...
						$common_search = (!empty($_POST['common_search']))?$_POST['common_search']:''; 
						 ?>
						 	...
						 	<input class="text" name="common_search" id="common_search" type="text" value="<?php echo (!empty($searched_value))?$searched_value:$common_search; ?>" placeholder="<?php echo (!empty($searched_value))?$searched_value:$common_search; ?>" placeholder="<?php echo (!empty($user_language[$user_selected]['lg_search']))?$user_language[$user_selected]['lg_search']:$default_language['en']['lg_search']; ?>"/>
						 	...
						 	<div class="search-country">
								...
								<select class="country select form-control" id="country" onchange="country_id_chnage(this)" name="change_country">
									...
									<option value="">--<?php echo (!empty($user_language[$user_selected]['lg_country']))?$user_language[$user_selected]['lg_country']:$default_language['en']['lg_country']; ?>--</option>
					...
					?>
						 	...
						 	<div class="search-state">
								...
								<select class="state select form-control" id="search_state" name="state">
									...
									<option value="">--<?php echo (!empty($user_language[$user_selected]['lg_state']))?$user_language[$user_selected]['lg_state']:$default_language['en']['lg_state']; ?>--</option>
						 	...
						 	<span class="search-btn">
						 		...
						 		<button type="submit" name="search_submit" value="search" class="btn btn-primary btn-block search_btn" ><?php echo (!empty($user_language[$user_selected]['lg_search']))?$user_language[$user_selected]['lg_search']:$default_language['en']['lg_search']; ?></button>	
