					...
					<div class="row">	
						...
						<div class="col-md-12">
							...
							<ol class="breadcrumb menu-breadcrumb">
								...
								<li class="active"><?php echo (!empty($user_language[$user_selected]['lg_reminder']))?$user_language[$user_selected]['lg_reminder']:$default_language['en']['lg_reminder']; ?></li>        
			...
			<div class="tab-content reminder-section">
				...
				<div class="row">
                                    ...
                                    <div class="col-md-12">
										...
										<h3 class="inner-title"> <?php echo (!empty($user_language[$user_selected]['lg_my_favorites_gigs']))?$user_language[$user_selected]['lg_my_favorites_gigs']:$default_language['en']['lg_my_favorites_gigs']; ?> </h3>
