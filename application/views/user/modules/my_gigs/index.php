			...
			<section class="profile-section">
				...
				<div class="container">
					...
					<div class="row">	
                       ...
                       $no_gigs_found =  (!empty($user_language[$user_selected]['lg_no_gigs_found']))?$user_language[$user_selected]['lg_no_gigs_found']:$default_language['en']['lg_no_gigs_found'];

                       $sorry = (!empty($user_language[$user_selected]['lg_sorry']))?$user_language[$user_selected]['lg_sorry']:$default_language['en']['lg_sorry'];

$display_result = $sorry.'! '. $no_gigs_found;



$gigs_found = (!empty($user_language[$user_selected]['lg_gigs_found']))?$user_language[$user_selected]['lg_gigs_found']:$default_language['en']['lg_gigs_found'];



$gig_found = (!empty($user_language[$user_selected]['lg_gig_found']))?$user_language[$user_selected]['lg_gig_found']:$default_language['en']['lg_gig_found'];

                       

/*$display_result = "Sorry! No Gigs Found ";*/

if($total_results!=0 && $total_results>1 ) { $display_result = $total_results . $gigs_found; } 

else if($total_results!=0 && $total_results==1) { $display_result = $total_results . $gig_found; } ?>

                            <h3 class="header-title"><?php echo (!empty($user_language[$user_selected]['lg_my_gigs']))?$user_language[$user_selected]['lg_my_gigs']:$default_language['en']['lg_my_gigs']; ?> <span>  <?php echo $display_result; ?> </span>
