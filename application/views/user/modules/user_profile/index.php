				...
				<div class="user-block">
					...
					<div class="user-image">
						...
						<div class="edit-profile">
							...
							<a href="<?php echo base_url().'profile' ?>" title="Edit Profile" class="btn btn-primary btn-block"><i class="fa fa-pencil"></i> <?php echo (!empty($user_language[$user_selected]['lg_edit_profile']))?$user_language[$user_selected]['lg_edit_profile']:$default_language['en']['lg_edit_profile']; ?></a> 
					...
					<?php if(!empty($country_name)) { ?>			<li class="user-country2"><?php echo (!empty($user_language[$user_selected]['lg_from']))?$user_language[$user_selected]['lg_from']:$default_language['en']['lg_from']; ?> : <?php echo $country_name; ?> <span class="ppcn country <?php echo $country_shortname; ?>"></span></li> <?php } ?>
												  ...
												  if($this->session->userdata('SESSION_USER_ID')) { if($user_id != $this->session->userdata('SESSION_USER_ID')) { ?>			<li class="contact-list"><a  href="javascript:;" data-toggle="modal" data-target="#message-popup"><?php echo (!empty($user_language[$user_selected]['lg_contact']))?$user_language[$user_selected]['lg_contact']:$default_language['en']['lg_contact']; ?></a></li>    <?php }  }?>
						...
						<div class="user-language">
							...
							<?php echo (!empty($user_language[$user_selected]['lg_speaks']))?$user_language[$user_selected]['lg_speaks']:$default_language['en']['lg_speaks']; ?>: <span><?php echo ucfirst($profile['lang_speaks']); ?></span><span>
	...
	<div class="container">
		...
		<div class="row">
			...
			$image = base_url().$profile['user_thumb_image'];		
			 ...
			 ?>
				...
				<h3 class="latest-title"><span><?php echo ucfirst($name); ?>'<?php echo (!empty($user_language[$user_selected]['lg_s_gigs']))?$user_language[$user_selected]['lg_s_gigs']:$default_language['en']['lg_s_gigs']; ?>&nbsp;&nbsp;</span></h3>
		...
		<div class="row">
					...
					<div class="product-detail">
						...
						<div class="author">
							...
							<div class="ratings">
														...
														<span class="stars-block star-<?php echo $gig_rating;?>"></span><span class="ratings-count">(<?php echo $user_feedbackcount;?>)</span>
			...
			<?php } } else { ?>      
				...
				<div class="col-sm-12"><p><?php echo (!empty($user_language[$user_selected]['lg_sorry']))?$user_language[$user_selected]['lg_sorry']:$default_language['en']['lg_sorry']; ?> ! <?php echo (!empty($user_language[$user_selected]['lg_no_gigs_found']))?$user_language[$user_selected]['lg_no_gigs_found']:$default_language['en']['lg_no_gigs_found']; ?></p></div>
			...
			<div class="col-md-3 col-xs-6">
				...
				<div class="widget-box clearfix">
					...
					<div class="text-center">
						...
						<h4><?php echo (!empty($user_language[$user_selected]['lg_new_feedbacks']))?$user_language[$user_selected]['lg_new_feedbacks']:$default_language['en']['lg_new_feedbacks']; ?></h4>
			...
			<div class="col-md-3 col-xs-6">
				...
				<div class="widget-box clearfix">
					...
					<div class="text-center">
						...
						<h4><?php echo (!empty($user_language[$user_selected]['lg_since_joining']))?$user_language[$user_selected]['lg_since_joining']:$default_language['en']['lg_since_joining']; ?></h4>
			...
			<div class="col-md-3 col-xs-6">
				...
				<div class="widget-box clearfix">
					...
					<div class="text-center">
						...
						<h4><?php echo (!empty($user_language[$user_selected]['lg_completed']))?$user_language[$user_selected]['lg_completed']:$default_language['en']['lg_completed']; ?></h4>

						<h2><?php echo $completed_gigs; ?> <span><?php echo (!empty($user_language[$user_selected]['lg_gigs']))?$user_language[$user_selected]['lg_gigs']:$default_language['en']['lg_gigs']; ?></span></h2>
			...
			<div class="col-md-3 col-xs-6">
				...
				<div class="widget-box clearfix">
					...
					<div class="text-center">                                                                           
						...
						<h4><?php echo (!empty($user_language[$user_selected]['lg_recent_deliveries']))?$user_language[$user_selected]['lg_recent_deliveries']:$default_language['en']['lg_recent_deliveries']; ?></h4>
	...
	<div class="container">
		...
		<div class="feedback-section">
			...
			<div class="view-header clearfix">
				...
				<h3 class="gig-view-title feedback-area"><?php echo (!empty($user_language[$user_selected]['lg_latest_feedbacks']))?$user_language[$user_selected]['lg_latest_feedbacks']:$default_language['en']['lg_latest_feedbacks']; ?>  <span id="stars-existing" class="starrr" data-rating="<?php echo $user_feedback;?>"> </span> (<?php echo count($feedbacks);?>)</h3>
			...
			<div class="more-feedback more_user_feedback">
				...
				<input type="hidden" id="load_more_gig_userid" name="load_more_gig_userid" value="<?php echo $profile_user_id;?>" />

				<a href="javascript:;" onclick="load_more_userfeedbacks();"><?php echo (!empty($user_language[$user_selected]['lg_more_feedbacks']))?$user_language[$user_selected]['lg_more_feedbacks']:$default_language['en']['lg_more_feedbacks']; ?></a>
				...
				<div class="new-message">
					...
					<form id="form_messagecontent_id" method="post" enctype="multipart/form-data" >
						...
						<div class="form-group">
							...
							<textarea name="chat_message_content" placeholder="<?php echo (!empty($user_language[$user_selected]['lg_message_to']))?$user_language[$user_selected]['lg_message_to']:$default_language['en']['lg_message_to']; ?> <?php echo $name; ?>" required="" id="messageone" class="form-control"></textarea>
