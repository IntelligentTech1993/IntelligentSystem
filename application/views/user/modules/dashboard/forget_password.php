							...
							<div class="search-box">
								<form onsubmit="return form_submit();" action="<?php echo base_url()."search"; ?>" method="post">
                                    ...
                                    value="<?php if(!empty($searched_value)){ echo $searched_value; } ?>"
                                     placeholder="<?php echo (!empty($user_language[$user_selected]['lg_search']))?$user_language[$user_selected]['lg_search']:$default_language['en']['lg_search']; ?>"/></span>
									<span class="search-category">
										<select class="selected_category" id="changecatetext" name="search_category">
                                            <option value=""><?php echo (!empty($user_language[$user_selected]['lg_all_categories']))?$user_language[$user_selected]['lg_all_categorieslg_all_categories']:$default_language['en']['lg_all_categories']; ?></option>
                                            <?php                                                                                     
													...
													<div class="row">
														<div class="col-md-12">
															<label><?php echo (!empty($user_language[$user_selected]['lg_new_password']))?$user_language[$user_selected]['lg_new_password']:$default_language['en']['lg_new_password']; ?></label>
                                                             <input type="password" name="new_password" id="new_password" class="form-control" placeholder="<?php echo (!empty($user_language[$user_selected]['lg_enter_new_password']))?$user_language[$user_selected]['lg_enter_new_password']:$default_language['en']['lg_enter_new_password']; ?>">
														</div>
														...
														<div class="col-md-12">
                                                            ...
                                                            <input type="password" name="repeat_password" id="repeat_password" class="form-control" placeholder="<?php echo (!empty($user_language[$user_selected]['lg_repeat_new_password']))?$user_language[$user_selected]['lg_repeat_new_password']:$default_language['en']['lg_repeat_new_password']; ?>">
														</div>
													</div>
												</div>
