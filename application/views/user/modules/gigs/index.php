 ...
 $i = 1;
	...
	<?php if($this->session->userdata('user_registeration')== "success")   { ?>
				...
				<div class="alert alert-success register_success">
					...
					<strong><?php echo (!empty($user_language[$user_selected]['lg_success']))?$user_language[$user_selected]['lg_success']:$default_language['en']['lg_success']; ?>!</strong> <?php echo (!empty($user_language[$user_selected]['lg_you_have_successfully_registered']))?$user_language[$user_selected]['lg_you_have_successfully_registered']:$default_language['en']['lg_you_have_successfully_registered']; ?>. <?php echo (!empty($user_language[$user_selected]['lg_please_check_registered_email']))?$user_language[$user_selected]['lg_please_check_registered_email']:$default_language['en']['lg_please_check_registered_email']; ?> .
				...
				<div class="alert alert-success register_success">
					...
					<strong><?php echo (!empty($user_language[$user_selected]['lg_success']))?$user_language[$user_selected]['lg_success']:$default_language['en']['lg_success']; ?>!</strong> <?php echo (!empty($user_language[$user_selected]['lg_you_have_successfully_verified']))?$user_language[$user_selected]['lg_you_have_successfully_verified']:$default_language['en']['lg_you_have_successfully_verified']; ?>. <?php echo (!empty($user_language[$user_selected]['lg_please_login_now']))?$user_language[$user_selected]['lg_please_login_now']:$default_language['en']['lg_please_login_now']; ?> .
		...
		<!-- <div class="row banner-box">
			...
			<div class="col-md-12 banner-content">
				...
				<button class="btn btn-default login-btn" data-toggle="modal" data-target="#login-popup" type="button"><?php echo (!empty($user_language[$user_selected]['lg_login']))?$user_language[$user_selected]['lg_login']:$default_language['en']['lg_login']; ?></button>

				<button class="btn btn-primary reg-btn" data-toggle="modal" data-target="#register-popup" type="button"><?php echo (!empty($user_language[$user_selected]['lg_register']))?$user_language[$user_selected]['lg_register']:$default_language['en']['lg_register']; ?></button>
		...
		<div class="row banner-box">
			...
			<div class="col-md-12 banner-content">
			<h1 class="text-left m-b-20"><?php echo (!empty($user_language[$user_selected]['lg_find_the_best']))?$user_language[$user_selected]['lg_find_the_best']:$default_language['en']['lg_find_the_best']; ?> <br><?php echo (!empty($user_language[$user_selected]['lg_instant_a_services_marketplace']))?$user_language[$user_selected]['lg_instant_a_services_marketplace']:$default_language['en']['lg_instant_a_services_marketplace']; ?></h1>
			...
			if(!empty($popular_category)) {
				?>
			<div class="quicklinks-popular">
				<span><?php echo (!empty($user_language[$user_selected]['lg_popular']))?$user_language[$user_selected]['lg_popular']:$default_language['en']['lg_popular']; ?>: </span>
				<ul class="list-unstyled list-inline">
					<?php 
					foreach ($popular_category as $popular_rows) {
						?>
					<li><a href="<?php echo base_url();?>search/<?php echo str_replace(' ', '-', $popular_rows['name']); ?>"><?php echo $popular_rows['name']; ?></a></li>
		...
		<div class="custom-feature-box row">
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				...
				<div class="feature-box fbox_1">
					...
					<img src="<?php echo base_url().$policy['policy_cropped_image']; ?>" alt="" width="190" height="150" />
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<h4 class="latest-title"><img src="<?php echo base_url().'assets/images/clock.png';?>" alt="Latest Gigs" width="35" height="34"><?php echo (!empty($user_language[$user_selected]['lg_latest_gigs']))?$user_language[$user_selected]['lg_latest_gigs']:$default_language['en']['lg_latest_gigs']; ?>&nbsp;&nbsp; 
