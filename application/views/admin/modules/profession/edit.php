					...
					<div class="card-box">
						<form id="admin_edit_profession" action="<?php echo base_url().'admin/profession/edit/'.$list['id']; ?>" method="post" >
							<div class="form-group">
								...
								<input type="text" name="profession" placeholder="Profession .... " class="form-control only_alphabets" id="profession" value="<?php if(!empty($list['profession_name'])){ echo $list['profession_name']; } ?>" required>
							</div>
							<div class="form-group">
