<div class="content-page">
	<div class="content">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="page-title m-b-20 m-t-0">Add Placeholder</h4>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<div class="card-box">
						<form id="admin_add_ip"  action="<?php echo base_url().'admin/policy_settings/create'; ?>" enctype= "multipart/form-data" method="post" >
							<div class="form-group">
								<label for="policy_name">Placeholder Name</label>
								<input type="text" name="policy_name" class="form-control only_alphabets" id="policy_name" required>
							</div>  
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" name="policy_description" maximumlength="250" class="form-control" id="policy_description" required>
							</div>
