				...
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<div class="card-box">
							 ...
							 <?php $page_key = $this->uri->segment(3); ?>
									...
									<div id="single_data" class="tab-pane active">
										...
										<form class="form-horizontal" autocomplete="off" id="" onsubmit="return keyword_validation();" action="" method="POST">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input name="placeholder" id="placeholder" class="form-control" type="text">
													
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label">Validation 1 :</label>
												<div class="col-sm-9">
													<input name="validation1" id="validation1" class="form-control" type="text">
													
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label">Validation 2 :</label>
												<div class="col-sm-9">
													<input name="validation2" id="validation2" class="form-control" type="text">
													
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label">Validation 3 :</label>
												<div class="col-sm-9">
													<input name="validation3" id="validation3" class="form-control" type="text">
